		...
		<div id="site_container">
			<div style="position: fixed; top: 80px; left: 0px; right: 0px; bottom: 0px; overflow-y: auto; ">
				...
				<?php } else { ?>
				    ...
				    <?php } ?>
			        <div style="float: left; width: <?php if(!$is_mobile){ ?>calc( 100% - 542px )<?php } else { ?>100%<?php } ?>; min-width: 350px; max-width: 100%; text-align: center; min-height: 500px; height: 100%; " id="chat_container">
		            <?php if(!$chat_data){ ?>
		                ...
		                <div style="width: 100%; height: calc( 100% - 160px ); min-height: 200px; max-height: 100%; margin-top: 20px; " class="centriert">
		                    <div style="height: 100%; width: 100%; position: relative;" id="chat_inner_data_content_container">
		                        ...
		                        if(!isset($_SESSION['pupil'])){
								    ...
								    ?>
								    <div style="position: absolute; bottom: 0px; right: 2px; left: 0px; height: auto; min-height: 30px; background-color: #222; ">
										<div style="width: 100%; height: 30px; display: none; color: white; font-size: 18px; "></div>
								        <textarea rows="1" onkeydown="message_input_keydown(event);" id="private_message_text" style="width: 100%; height: 30px; font-size: 24px; text-align: left; resize: none; background-color: transparent; word-wrap: break-word; white-space: pre-wrap;" class="text" placeholder="Meine Nachricht.."></textarea>
								    </div>
